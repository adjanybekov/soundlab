                ...
                <div id="navbar" class="navbar-collapse collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                     ...
                     <!--target="_blank" linkin yeni sayfada açılmasını sağlar-->
						 ...
						 <a class="dilSec" href="apps.php" style="color:red">TR ||
                         <a class="dilSec" href="apps1.php"style="color:red">ENG</a>
	</nav>
  </header>
    ...
    <div class="container" id="Services">
      <div class="row">
        <div class="twelave columns">
          <div class="Services">
            <h3>GÜVENLİK KAMERALARI SES ENTEGRASYONU</h3>
			<p>Ev/işyeri, kampüs/açık alan güvenliğinin sağlanmasında güvenlik kameralarından gelen seslere, geliştirdiğimiz algoritmalar uygulanarak tehlike içeren sesler tespit edilmektedir.<br/>
			Bu algortimalar masaüstü ve bulut uygulaması olarak kullanılabilmektedir. </p>
          </div>
		  <center><img src="img/home-slider/slider-1.png" width="85%" height="85%" alt=""></center>
        </div>
      </div>
    </div>
</section>
...
<section id="project">
    <div class="container" id="Protofol">
      <div class="row">
        <div class="twelave columns">
          <div class="protofol">
            <h3>TRAFİK KAZASI TESPİTİ</h3>
			<p>E-Call Avrupa Birliği ülkelerinde Nisan 2018’den itibaren yeni satılan araçlar için zorunlu olmuştur.
			E-Call kaza anında otomatik olarak acil servisleri arayarak; kazazedelere müdahale zamanınını kısaltmayı amaçlamaktadır. 
               Eski araçlarda bu sistem zorunlu değildir. Bizim çözümümüz eski araçlar için E-Call benzeri bir uygulama sunmaktadır.</p>
          </div>
		  <center><img src="img/home-slider/slider-2.png" width="85%" height="85%" alt=""></center>
        </div>
      </div>
    </div>
</section>
<section class="blog_main_area p_100">
    <section class="sitesaction">
      ...
      <div class="row">
        <div class="twelave columns">
          <div class="protofol">
            <h3>KİŞİSEL GÜVENLİK UYGULAMASI</h3>
			<p>Mobil cihazlarda çalışan SoundLabAI kişisel güvenlik uygulaması, çığlık, cam kırılması, bebek ağlaması, trafik kazası gibi sesleri tespit eder ve bildirir.<br/>
				Yalnız yaşayan anne veya babanız düştüğünde çığlığından haberdar olursunuz.
				Bebeğiniz ağladığında sizi haberdar eder, bebek telsizi almanıza gerek kalmaz.</p>
          </div>
		  <center><img src="img/home-slider/slider-3.png" width="25%" height="25%" alt=""></center>
        </div>
      </div>
	  </div>
    </section>
...
<script src="waypoints1.min.js"></script> 
