                ...
                <div id="navbar" class="navbar-collapse collapse">                  
                    <ul class="nav navbar-nav navbar-right">
                     ...
                     <!--target="_blank" linkin yeni sayfada açılmasını sağlar-->
						 ...
						 <a class="dilSec" href="aboutus.php" style="color:red">TR ||</a>
                         <a class="dilSec" href="aboutus1.php"style="color:red">ENG</a>
	</nav>
  </header>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="challange_text_inner">
						   ...
						   <p>SoundLabAI 2018 yılında Tübitak desteği ile ODTÜ Teknokent’te kurulmuştur.<br/>
						   Farklı disiplinlerde yıllarca yapılan çalışmalardan gelen tecrübe,<br/>
						   doktora eğitiminden gelen teorik bilgilerle birleştirilerek şirketin temeli oluşturulmuştur.<br/>
                           SoundLabAI önce Türkiye’de sonra dünyada ses analitiği konusunda ilk akla gelen firmalar arasına girme amacıyla yola çıkmıştır.<br/>
						   Yüksek kaliteli, tehlike içeren  ses tanıma algoritmalarımızı  masaüstü, bulut, mobil ve gömülü yazılım uygulaması haline getirerek<br/>
                    ...
                    <div class="col-lg-6 challange_img">
                        <div class="challange_img_inner">
                            <img class="img-fluid" src="img/sound1.png"  alt="">
                        </div>
                    </div>
                </div>
            </div>
